...
import photoAIM1 from '@/assets/images/about/2024-AIM.jpeg';
import photoWSAI1 from '@/assets/images/about/imageWSAI1.jpg';
import photoWSAI2 from '@/assets/images/about/imageWSAI2.jpg';
import photoWSAI3 from '@/assets/images/about/imageWSAI3.jpg';
...
export const metadata = {
  title: "Gathrean Dela Cruz's Work",
};
    ...
    <div className="page">
      ...
      <div className="content-block">
        ...
        <div className="conference-photos">
          <Image src={photoAIM1} alt="Gathrean at AIM 2024 Conference in San Francisco" className="conference-photo" width={200} height={150} />
        </div>
      ...
      <div className="content-block">
        ...
        <div className="conference-photos">
          <Image src={photoWSAI1} alt="WSAI 2024 virtual presentation" className="conference-photo" width={200} height={150} />
          <Image src={photoWSAI2} alt="WSAI 2024 team on Zoom" className="conference-photo" width={200} height={150} />
          <Image src={photoWSAI3} alt="WSAI 2024 group session" className="conference-photo" width={200} height={150} />
        </div>
      ...
      <div className="item-list">
        {projects.map((project, i) => (
          <div key={i} className="item">
            <div className="item-header">
              <Image className="item-icon" src={project.icon} alt={project.name} width={40} height={40} />
              <div>
                <h3>{project.name}</h3>
